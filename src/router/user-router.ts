...
router.post(
	"/getFriendListFromId",
	authMiddleware,
	contractController.getFriendListFromId,
);
router.post("/deleteFriend", authMiddleware, contractController.deleteFriend);
router.post(
	"/findFriendCandidatesForUserFromId",
	authMiddleware,
	userController.findFriendCandidatesForUserFromId,
);

router.post(
	"/getAllUsersChats",
	authMiddleware,
	userController.getAllUsersChats,
);
